...
public class ArrayOfFicheEmploye extends Vector<FicheEmploye> implements KvmSerializable
{
    ...
    public ArrayOfFicheEmploye(Object inObj, ExtendedSoapSerializationEnvelope __envelope)
    {
        if (inObj == null)
            return;
        ...
        for (int i0=0;i0< size;i0++)
        {
            ...
            if (obj!=null && obj instanceof AttributeContainer)
            {
                ...
                FicheEmploye j1= (FicheEmploye)__envelope.get(j, FicheEmploye.class,false);
                add(j1);
            }
        }
}
