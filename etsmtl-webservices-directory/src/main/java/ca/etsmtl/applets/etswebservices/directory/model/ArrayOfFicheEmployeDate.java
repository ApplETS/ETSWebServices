...
public class ArrayOfFicheEmployeDate extends Vector<FicheEmployeDate> implements KvmSerializable
{
    ...
    public ArrayOfFicheEmployeDate(Object inObj,ExtendedSoapSerializationEnvelope __envelope)
    {
        if (inObj == null)
            return;
        ...
        for (int i0=0;i0< size;i0++)
        {
            ...
            if (obj!=null && obj instanceof AttributeContainer)
            {
                ...
                FicheEmployeDate j1= (FicheEmployeDate)__envelope.get(j, FicheEmployeDate.class,false);
                add(j1);
            }
        }
}
