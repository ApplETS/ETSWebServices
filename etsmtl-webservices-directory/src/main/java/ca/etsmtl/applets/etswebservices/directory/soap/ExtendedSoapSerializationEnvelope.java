...
import ca.etsmtl.applets.etswebservices.directory.model.FicheEmployeDate;
import ca.etsmtl.applets.etswebservices.directory.model.GetFiche;
import ca.etsmtl.applets.etswebservices.directory.model.GetFicheData;
import ca.etsmtl.applets.etswebservices.directory.model.GetFicheDataResponse;
import ca.etsmtl.applets.etswebservices.directory.model.GetFicheResponse;
import ca.etsmtl.applets.etswebservices.directory.model.GetListeDepartement;
import ca.etsmtl.applets.etswebservices.directory.model.GetListeDepartementResponse;
import ca.etsmtl.applets.etswebservices.directory.model.Recherche;
import ca.etsmtl.applets.etswebservices.directory.model.RechercheDate;
import ca.etsmtl.applets.etswebservices.directory.model.RechercheDateResponse;
import ca.etsmtl.applets.etswebservices.directory.model.RechercheResponse;
import ca.etsmtl.applets.etswebservices.directory.model.Service;
...
public class ExtendedSoapSerializationEnvelope extends SoapSerializationEnvelope {
    ...
    static {
        classNames.put("http://etsmtl.ca/^^FicheEmploye",FicheEmploye.class);
        classNames.put("http://etsmtl.ca/^^FicheEmployeDate",FicheEmployeDate.class);
        classNames.put("http://etsmtl.ca/^^Service",Service.class);
        classNames.put("http://etsmtl.ca/^^Recherche",Recherche.class);
        classNames.put("http://etsmtl.ca/^^RechercheResponse",RechercheResponse.class);
        classNames.put("http://etsmtl.ca/^^RechercheDate",RechercheDate.class);
        classNames.put("http://etsmtl.ca/^^RechercheDateResponse",RechercheDateResponse.class);
        classNames.put("http://etsmtl.ca/^^GetFicheData",GetFicheData.class);
        classNames.put("http://etsmtl.ca/^^GetFicheDataResponse",GetFicheDataResponse.class);
        classNames.put("http://etsmtl.ca/^^GetListeDepartement",GetListeDepartement.class);
        classNames.put("http://etsmtl.ca/^^GetListeDepartementResponse",GetListeDepartementResponse.class);
        classNames.put("http://etsmtl.ca/^^GetFiche",GetFiche.class);
        classNames.put("http://etsmtl.ca/^^GetFicheResponse",GetFicheResponse.class);
        classNames.put("http://etsmtl.ca/^^ArrayOfFicheEmploye",ArrayOfFicheEmploye.class);
        classNames.put("http://etsmtl.ca/^^ArrayOfFicheEmployeDate",ArrayOfFicheEmployeDate.class);
        classNames.put("http://etsmtl.ca/^^ArrayOfService",ArrayOfService.class);
    }   
